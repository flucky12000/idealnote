...
public class NavDrawerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(com.dycody.android.idealnote.R.layout.drawer_list_item, parent, false);
            ...
            holder.imgIcon = (ImageView) convertView.findViewById(com.dycody.android.idealnote.R.id.icon);
            holder.txtTitle = (TextView) convertView.findViewById(com.dycody.android.idealnote.R.id.title);
        ...
        if (isSelected(position)) {
            ...
            int color = mActivity.getResources().getColor(com.dycody.android.idealnote.R.color.colorPrimaryDark);
            ...
            holder.txtTitle.setTextColor(mActivity.getResources().getColor(com.dycody.android.idealnote.R.color.drawer_text));
        }
    ...
    private boolean isSelected(int position) {
        ...
        String[] navigationListCodes = mActivity.getResources().getStringArray(com.dycody.android.idealnote.R.array.navigation_list_codes);
        ...
        String navigationLocalized = mActivity.getResources().getStringArray(com.dycody.android.idealnote.R.array.navigation_list)[index];
