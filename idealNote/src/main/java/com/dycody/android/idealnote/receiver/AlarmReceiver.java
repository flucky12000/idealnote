 ...
 */
package com.dycody.android.idealnote.receiver;
...
import com.dycody.android.idealnote.SnoozeActivity;
import com.dycody.android.idealnote.db.DbHelper;
import com.dycody.android.idealnote.models.Note;
import com.dycody.android.idealnote.services.NotificationListener;
...
import com.dycody.android.idealnote.utils.ParcelableUtil;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	private void createNotification(Context mContext, Note note) {
		...
		notificationsHelper.createNotification(com.dycody.android.idealnote.R.drawable.ic_stat_notification, title, notifyIntent).setLedActive()
				.setMessage(text);
		...
		notificationsHelper.getBuilder()
				.addAction(com.dycody.android.idealnote.R.drawable.ic_material_reminder_time_light, TextHelper
						.capitalize(mContext.getString(com.dycody.android.idealnote.R.string.snooze)) + ": " + snoozeDelay, piSnooze)
				.addAction(com.dycody.android.idealnote.R.drawable.ic_remind_later_light,
						TextHelper.capitalize(mContext.getString(com.dycody.android.idealnote.R.string
