...
public class WidgetConfigurationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.dycody.android.idealnote.R.layout.activity_widget_configuration);

        mRadioGroup = (RadioGroup) findViewById(com.dycody.android.idealnote.R.id.widget_config_radiogroup);
        mRadioGroup.setOnCheckedChangeListener((group, checkedId) -> {
            switch (checkedId) {
                case com.dycody.android.idealnote.R.id.widget_config_notes:
                    categorySpinner.setEnabled(false);
                    break;

                    case com.dycody.android.idealnote.R.id.widget_config_categories:
        ...
        categorySpinner = (Spinner) findViewById(com.dycody.android.idealnote.R.id.widget_config_spinner);
        categorySpinner.setEnabled(false);
        DbHelper db = DbHelper.getInstance();
        ArrayList<Category> categories = db.getCategories();
        categorySpinner.setAdapter(new NavDrawerCategoryAdapter(this, categories));

        Button configOkButton = (Button) findViewById(com.dycody.android.idealnote.R.id.widget_config_confirm);
        configOkButton.setOnClickListener(v -> {

            if (mRadioGroup.getCheckedRadioButtonId() == com.dycody.android.idealnote.R.id.widget_config_notes) {
            ...
            CheckBox showThumbnailsCheckBox = (CheckBox) findViewById(com.dycody.android.idealnote.R.id.show_thumbnails);
