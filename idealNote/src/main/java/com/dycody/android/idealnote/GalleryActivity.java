...
import com.dycody.android.idealnote.models.views.InterceptorFrameLayout;
...
public class GalleryActivity extends ActionBarActivity {
    ...
    @Override
    public void onStart() {
		((IdealNote)getApplication()).getAnalyticsHelper().trackScreenView(getClass().getName());
        super.onStart();
    }
