 ...
 */
package com.dycody.android.idealnote.helpers.date;
...
public class DateHelper {
    ...
    public static String getNoteReminderText(long reminder) {
        return IdealNote.getAppContext().getString(com.dycody.android.idealnote.R.string.alarm_set_on) + " " + getDateTimeShort(IdealNote
				.getAppContext(), reminder);
    }


    public static String getNoteRecurrentReminderText(long reminder, String rrule) {
        return DateHelper.formatRecurrence(IdealNote.getAppContext(), rrule) + " " + IdealNote.getAppContext().getString
                (com.dycody.android.idealnote.R.string.starting_from) + " " + DateHelper.getDateTimeShort(IdealNote.getAppContext(), reminder);
    }


	public static String getFormattedDate(Long timestamp, boolean prettified) {
		if(prettified) {
			return com.dycody.android.idealnote.utils.date.DateUtils.prettyTime(timestamp);
		} else {
			return DateHelper.getDateTimeShort(IdealNote.getAppContext(), timestamp);
		}
	}
