...
import com.dycody.android.idealnote.utils.ResourcesUtils;
...
import com.dycody.android.idealnote.async.DataBackupIntentService;
...
public class SettingsFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments() != null && getArguments().containsKey(XML_NAME)) {
			xmlId = ResourcesUtils.getXmlId(IdealNote.getAppContext(), ResourcesUtils.ResourceIdentifiers.xml, String
...
//		});
		...
		if (changelog != null) {
			changelog.setOnPreferenceClickListener(arg0 -> {
				...
				((IdealNote)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_changelog");
				...
				new MaterialDialog.Builder(getActivity())
						...
						.callback(new MaterialDialog.ButtonCallback() {
							...
							public void onPositive(MaterialDialog materialDialog) {
								...
								((IdealNote)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_tour_show_again");
					...
					new MaterialDialog.Builder(getActivity())
							...
							.callback(new MaterialDialog.ButtonCallback() {
								...
								public void onPositive(MaterialDialog materialDialog) {
									...
									((IdealNote)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING,
	...
	private void export(View v) {
		...
		new MaterialDialog.Builder(getActivity())
				...
				.callback(new MaterialDialog.ButtonCallback() {
					@Override
					public void onPositive(MaterialDialog materialDialog) {
						((IdealNote)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_export_data");
