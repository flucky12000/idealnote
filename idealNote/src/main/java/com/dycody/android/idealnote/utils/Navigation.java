...
public class Navigation {
    ...
    public static int getNavigation() {
        String[] navigationListCodes = IdealNote.getAppContext().getResources().getStringArray(com.dycody.android.idealnote.R.array.navigation_list_codes);
    ...
    public static String getNavigationText() {
        Context mContext = IdealNote.getAppContext();
        String[] navigationListCodes = mContext.getResources().getStringArray(com.dycody.android.idealnote.R.array.navigation_list_codes);
    ...
    public static Long getCategory() {
        if (getNavigation() == CATEGORY) {
			return Long.valueOf(IdealNote.getAppContext().getSharedPreferences(Constants.PREFS_NAME, Context
