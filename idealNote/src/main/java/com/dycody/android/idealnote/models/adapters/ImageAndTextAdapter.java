...
import com.dycody.android.idealnote.models.holders.ImageAndTextItem;
...
public class ImageAndTextAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(com.dycody.android.idealnote.R.layout.image_and_text_item,
                    parent, false);
            ...
            holder.image = (ImageView) convertView.findViewById(com.dycody.android.idealnote.R.id.image);
            holder.text = (TextView) convertView.findViewById(com.dycody.android.idealnote.R.id.text);
