...
public abstract class WidgetProvider extends AppWidgetProvider {
    ...
    private void setLayout(Context context, AppWidgetManager appWidgetManager, int widgetId) {
        ...
        map.put(com.dycody.android.idealnote.R.id.list, pendingIntentList);
        map.put(com.dycody.android.idealnote.R.id.add, pendingIntentDetail);
        map.put(com.dycody.android.idealnote.R.id.camera, pendingIntentDetailPhoto);
