package com.dycody.android.idealnote.models.views;
...
import com.dycody.android.idealnote.models.listeners.AbsListViewScrollDetector;
import com.dycody.android.idealnote.utils.Constants;
import com.getbase.floatingactionbutton.AddFloatingActionButton;
import com.getbase.floatingactionbutton.FloatingActionsMenu;

import it.feio.android.checklistview.utils.DensityUtil;
import com.dycody.android.idealnote.models.listeners.OnFabItemClickedListener;
...
public class Fab {
    ...
    private void init() {
        ...
        AddFloatingActionButton fabAddButton = (AddFloatingActionButton) fab.findViewById(com.dycody.android.idealnote.R.id.fab_expand_menu_button);
        ...
        fab.findViewById(com.dycody.android.idealnote.R.id.fab_checklist).setOnClickListener(onClickListener);
        fab.findViewById(com.dycody.android.idealnote.R.id.fab_camera).setOnClickListener(onClickListener);

        if (!expandOnLongClick) {
            View noteBtn = fab.findViewById(com.dycody.android.idealnote.R.id.fab_note);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            int navBarHeight = Display.getNavigationBarHeightKitkat(IdealNote.getAppContext());
            FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) fab.getLayoutParams();
            params.setMargins(params.leftMargin, params.topMargin, params.rightMargin,
                    navBarHeight + DensityUtil.pxToDp(params.bottomMargin, IdealNote.getAppContext()));
    ...
    public void setOverlay(int colorResurce) {
        View overlayView = new View(IdealNote.getAppContext());
